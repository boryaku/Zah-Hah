    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id" title="${message(code: 'level.id.label', default: 'Id')}"/>
                ...
                <th><g:message code="level.program.label" default="Program"/></th>
            ...
            <g:each in="${levelInstanceList}" status="i" var="levelInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show"
                                id="${levelInstance.id}">${fieldValue(bean: levelInstance, field: "id")}</g:link></td>

                    <td>${fieldValue(bean: levelInstance, field: "description")}</td>

                    <td>${fieldValue(bean: levelInstance, field: "name")}</td>

                    <td>${fieldValue(bean: levelInstance, field: "program")}</td>
