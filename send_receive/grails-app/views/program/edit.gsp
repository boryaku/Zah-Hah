            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="levels"><g:message code="program.levels.label" default="Levels"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: programInstance, field: 'levels', 'errors')}">

                        <ul>
                            <g:each in="${programInstance?.levels?}" var="l">
                                <li><g:link controller="level" action="show"
                                            id="${l.id}">${l?.encodeAsHTML()}</g:link></li>
                            </g:each>
                        </ul>
                        <g:link controller="level" action="create"
                                params="['program.id': programInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'level.label', default: 'Level')])}</g:link>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="program.description.label"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="name"><g:message code="program.name.label" default="Name"/></label>
                    </td>
